...
RUN_TAG="${RUN_TAG:-tvsum_spair_attention_lr${LR}_wd${WEIGHT_DECAY}_lp${LAMBDA_PAIR}_pm${PAIR_MARGIN}_la${LAMBDA_ALIGN}_laux${LAMBDA_AUX}_m${TEXT_COND_NUM}_seed${SEED}}"
