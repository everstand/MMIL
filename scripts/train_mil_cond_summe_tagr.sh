...
SHOT_UTILITY_PATH="${SHOT_UTILITY_PATH:-pseudo_labels/summe/shot_utility_v3.npy}"
TEXT_FEATURE_PATH="${TEXT_FEATURE_PATH:-features/text_summe_v3.h5}"
STRUCTURED_CAPTION_PATH="${STRUCTURED_CAPTION_PATH:-captions_raw/summe_dense_captions_structured_v3.json}"
